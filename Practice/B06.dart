void main() {
  ...
  if (number1 == number2) {
    ...
    print(
        "[16] (c) number1[$number1] not equal to number2[$number2] and number3[$number3].");
  }
  ...
  switch (switchStatus) {
    ...
    case 'ON':
      ...
      break;
    default: // 위의 경우 중 하나도 충족되지 않았을 때
  ...
  assert(programTermination == 'NORMAL'); // assert(true): 프로그램 수행에 영향X
  //assert(programTermination != 'NORMAL'); // assert(false): 프로그램 수행 중지
